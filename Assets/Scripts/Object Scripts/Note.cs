...
public class Note : MonoBehaviour {
	...
	private static string[] NoteText = new string[] {
		...
		"Entry 4 \nI think my idea is not as ridiculous as I thought, I think I have found a way. I just need to make sure that it works first. On paper it looks good, but that's not enough. I need to find out if it's the real deal. \nI have collected all my findings in my previous entry, I will take it to my colleagues and make it work...",
        ...
        "Developed by:\nJoseph Burke & Judith Hartmann\n\nLevel Design/Artwork:\nDaniel Sheehan & John Sethiel\n\nStory:\nAbel García"
    };
	...
	public void Collect (Player player) {
        if (visible)
        {
            ...
            player.changeForm(Player.PlayerState.Note);
